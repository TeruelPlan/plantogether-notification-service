...
/**
 * RabbitMQ topology for notification-service. Declares queues this service consumes from the shared
 * {@code plantogether.events} topic exchange.
 */
@Configuration
public class RabbitConfig {
  ...
  @Bean
  public Binding stompPollLockedBinding(
      Queue stompPollLockedQueue, TopicExchange plantogetherExchange) {
